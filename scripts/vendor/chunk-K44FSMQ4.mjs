import { a as F } from "./chunk-W4HX7OP5.mjs";
import { b as C, q as m, r as u } from "./chunk-4BL4NTEI.mjs";
import { f as P } from "./chunk-DO2IV25C.mjs";
import { h as A } from "./chunk-LA34HORX.mjs";
import { h as j } from "./chunk-KPMZENE5.mjs";
...
async function q(s, r) {
  ...
  return s.status === 401 &&
    ...
    ? (M.reportError(
      ...
      { status: "retry" })
    : { status: "error", error: new C({ data: i, message: t, status: s.status, ref: n, code: e }) };
}
var v = class {
  constructor(r) {
    this.baseURL = r;
...
//# sourceMappingURL=https://app.framerstatic.com/chunk-K44FSMQ4.mjs.map
