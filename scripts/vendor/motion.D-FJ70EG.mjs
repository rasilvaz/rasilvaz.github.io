...
function Je(e) {
  let t = We(e);
  return Ke(t)(t.values.map((e, n) => Bc(e, t.split[n])));
}
function Ye(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function jt() {
  if (Cl) {
    ...
    (t.forEach((e) => {
      ...
      e.forEach((e) => {
        e.suspendedScrollY !== void 0 && E.scrollTo(0, e.suspendedScrollY);
      }));
  }
...
function $t(e, t, n = 1) {
  ...
  let [r, i] = Qt(e);
  if (!r) return;
  let a = E.getComputedStyle(t).getPropertyValue(r);
  if (a) {
    let e = a.trim();
    return Ms(e) ? parseFloat(e) : e;
  }
  return pc(i) ? $t(i, t, n + 1) : i;
}
function en(e) {
  let t = [{}, {}];
  return (
...
function fn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    let r = e.getValue(t, e.latestValues[t] ?? null),
      i = s[t];
    if (i === void 0 || (f && dn(f, t))) continue;
    let o = { delay: n, ...Xt(a || {}, t) };
    ...
    let p = !1;
    if (E.MotionHandoffAnimation) {
      let n = un(e);
      if (n) {
        let e = E.MotionHandoffAnimation(n, t, z);
        e !== null && ((o.startTime = e), (p = !0));
      }
    }
    cn(e, t);
    let m = l ?? e.shouldReduceMotion;
    r.start(nu(t, r, i, m && iu.has(t) ? { type: !1 } : o, e, p));
    let h = r.animation;
    h && d.push(h);
  }
  if (o) {
      ...
      let n = !1,
        ...
        c = (e) => {
          ((n = !1),
            ...
            E.removeEventListener(`pointercancel`, c),
            r && ((r = !1), s(e)));
        },
        l = () => {
          ((n = !0),
            E.addEventListener(`pointerup`, c, i),
            E.addEventListener(`pointercancel`, c, i));
        },
        u = (e) => {
  ...
  let [r, i, a] = wn(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        o = { ...i, capture: !0 },
        s = (e, t) => {
          (E.removeEventListener(`pointerup`, c, o),
            E.removeEventListener(`pointercancel`, l, o),
            ju.has(r) && ju.delete(r),
            jn(e) && typeof a == `function` && a(e, { success: t }));
        },
        c = (e) => {
          s(e, r === E || r === document || n.useGlobalTarget || Du(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
      (E.addEventListener(`pointerup`, c, o), E.addEventListener(`pointercancel`, l, o));
    };
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? E : e).addEventListener(`pointerdown`, o, i),
        xn(e) &&
  ...
  return (
    ...
    () => {
      (zu.delete(e),
        !zu.size &&
          typeof Bu == `function` &&
          (E.removeEventListener(`resize`, Bu), (Bu = void 0)));
    }
  );
}
function Bn(e, t) {
...
function Kn(e, t, n = {}) {
  ...
  if (
    (e.attach((e, t) => {
      ((a = e), (o = (e) => t(qn(e, s))), z.postRender(u));
    }, c),
    X(t))
  ) {
...
function nr() {
  if (((Zu.current = !0), Qu))
    if (E.matchMedia) {
      let e = E.matchMedia(`(prefers-reduced-motion)`),
...
function yi(e) {
  ...
  if (!t) return;
  let n = un(t);
  if (E.MotionHasOptimisedAnimation(n, `transform`)) {
    let { layout: t, layoutId: r } = e.options;
    E.MotionCancelOptimisedAnimation(n, `transform`, z, !(t || r));
  }
  let { parent: r } = e;
...
function bi({
  ...
  return class {
    ...
    willUpdate(e = !0) {
      ...
      if (
        (E.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && yi(this),
    ...
    removeTransform(e) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        let r;
        (n.instance &&
          (lr(n.latestValues) && n.updateSnapshot(), (r = Q()), A(r, n.measurePageBox())),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        ...
        (A(t, n), br(t, i), qr(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
...
function Ji({ children: e, isPresent: t, anchorX: i, anchorY: a, root: o, pop: s }) {
  let c = T(),
    u = l(null),
    d = l({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0, direction: `ltr` }),
    { nonce: f } = n($),
    p = qi(u, e.props?.ref ?? e?.ref);
  return (
    r(() => {
      let { width: e, height: n, top: r, left: l, right: p, bottom: m, direction: h } = d.current;
      if (t || s === !1 || !u.current || !e || !n) return;
      let g = h === `rtl`,
        _ = i === `left` ? (g ? `right: ${p}` : `left: ${l}`) : g ? `left: ${l}` : `right: ${p}`,
        v = a === `bottom` ? `bottom: ${m}` : `top: ${r}`;
      ...
      return (
        ...
        `),
        () => {
          (u.current?.removeAttribute(`data-motion-pop-id`), b.contains(y) && b.removeChild(y));
        }
      );
    }, [t]),
    m(Xd, {
...
function oa({ children: e, isValidProp: t, ...r }) {
  t && ia(t);
  let i = n($);
  ((r = { ...i, ...r }),
    (r.transition = Yt(r.transition, i.transition)),
...
function ua(e) {
  let { initial: t, animate: r } = la(e, n(uf));
  return v(() => ({ initial: t, animate: r }), [da(t), da(r)]);
}
function da(e) {
...
function xa(e, t, i, a, o, s) {
  let { visualElement: u } = n(uf),
    d = n(af),
    f = n(js),
    p = n($),
    m = p.reducedMotion,
  ...
  let v = g.current,
    y = n(ff);
  v && !v.projection && o && (v.type === `html` || v.type === `svg`) && Sa(g.current, i, o, y);
  let b = l(!1);
  r(() => {
    v && b.current && v.update(i, f);
  });
  let x = i[su],
    S = l(
      !!x && E !== void 0 && !E.MotionHandoffIsComplete?.(x) && E.MotionHasOptimisedAnimation?.(x)
    );
  return (
    As(() => {
      ((_.current = !0),
    ...
    c(() => {
      v &&
        ...
        (S.current &&=
          (queueMicrotask(() => {
            E.MotionHandoffMarkAsComplete?.(x);
          }),
          !1)),
...
function wa(e, { forwardMotionProps: t = !1, type: r } = {}, i, a) {
  i && na(i);
  let o = r ? r === `svg` : _a(e),
    s = o ? _f : gf;
  function c(r, c) {
    ...
    if (!d && E !== void 0) {
      Ea(u, i);
      let t = Da(u);
      ((l = t.MeasureLayout), (f.visualElement = xa(e, p, u, a, t.ProjectionNode, o)));
    }
    return b(uf.Provider, {
      value: f,
      children: [
        l && f.visualElement ? m(l, { visualElement: f.visualElement, ...u }) : null,
        va(e, r, ya(p, f.visualElement, c), p, d, t, o),
      ],
    });
  }
...
function Qa(e) {
  let [t, r] = Xi(),
    i = n(Os);
  return m(If, { ...e, layoutGroup: i, switchLayoutGroup: n(ff), isPresent: t, safeToRemove: r });
}
function $a(e, t, n) {
  let { props: r } = e;
  e.animationState && r.whileHover && e.animationState.setActive(`whileHover`, n === `Start`);
  let i = r[`onHover` + n];
  i && z.postRender(() => i(t, ka(t)));
}
function eo(e, t, n) {
  let { props: r } = e;
...
function Oo(e, t) {
  return E === void 0 ? !1 : e ? kl() && !!yo(t) : Ol();
}
...
function Io(e, t = {}) {
  ...
  if (i) return No(a);
  let o = Ao(a());
  return (r(() => Kn(o, e, t), [o, JSON.stringify(t)]), o);
}
function Lo(e, t = {}) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((T > 0 && vt(u, T), c.length === 1 && c.unshift(null), m && `${m}${vp}`, m && m < vp)) {
          let e = b > 0 ? _ / b : 0;
          b = Ko(b, m, _);
          let t = [...c],
            n = [...u];
        ...
        let E = w + b;
        (Yo(r, c, y, u, w, E), (g = Math.max(x + b, g)), (f = Math.max(E, f)));
      };
    if (X(p)) {
      let e = $o(p, s);
      _(m, h, es(`default`, e));
...
function ys({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  let s = N(() => Yf[t]),
    u = [],
    d = l(!1),
    f = l(null),
    p = {
      ...
      registerItem: (e, t) => {
        ...
        (r === -1 ? u.push({ value: e, layout: t[n] }) : (u[r].layout = t[n]), u.sort(bs));
      },
      updateOrder: (e, t, n) => {
        if (d.current) return;
        let a = vs(u, e, t, n);
...
function ws(e, t, n) {
  let r = t.getBoundingClientRect(),
    ...
    a = n === `x` ? Math.min(E.innerWidth, r.right) : Math.min(E.innerHeight, r.bottom),
    o = e - i,
    s = a - e;
  if (o < Op) {
    let e = 1 - o / Op;
...
function Ts(e, t, n, r) {
  ...
  let i = Cs(e, n);
  if (!i) return;
  let { amount: a, edge: o } = ws(t - (n === `x` ? E.scrollX : E.scrollY), i, n);
  if (o === null) {
  ...
  if (s !== o) {
    ...
    let e =
      n === `x`
        ? i.scrollWidth - (c ? E.innerWidth : i.clientWidth)
        : i.scrollHeight - (c ? E.innerHeight : i.clientHeight);
    jp.set(i, e);
  }
  if (a > 0) {
    let e = jp.get(i);
    if ((n === `x` ? (c ? E.scrollX : i.scrollLeft) : c ? E.scrollY : i.scrollTop) >= e) return;
  }
  n === `x`
    ? c
      ? E.scrollBy({ left: a })
  ...
  return m(u, {
    ...
    onDrag: (e, t) => {
      let { velocity: n, point: i } = t,
        o = f[h].get();
      (_(r, o, n[h]), Ts(v.current, i[h], h, n[h]), a && a(e, t));
    },
    onDragEnd: (e, t) => {
      (xs(), o && o(e, t));
    },
...
var Os,
  ...
  Fp = t(() => {
    (o(),
      ...
      (Ec = { test: xc(`#`), parse: He, transform: Tc.transform }),
      (Dc = (e) => ({
      ...
      (nl = { decay: ht, inertia: ht, tween: St, keyframes: St, spring: pt }),
      (rl = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (al = class extends rl {
        ...
        initAnimation() {
          ...
          s !== St &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Fs(il, at(o[0], o[1]))), (o = [0, 100]));
      ...
      (Tl = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (xl.add(this), Sl || ((Sl = !0), z.read(Mt), z.resolveKeyframes(jt)))
      ...
      (El = (e) => e.startsWith(`--`)),
      (Dl = {}),
      (Ol = Ft(() => E.ScrollTimeline !== void 0, `scrollTimeline`)),
      (kl = Ft(() => E.ViewTimeline !== void 0, `viewTimeline`)),
      (Al = Ft(() => {
        try {
      ...
      (Su = class extends Tl {
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = E.pageYOffset),
            (this.measuredOrigin = bl[n](e.measureViewportBox(), E.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = bl[t](e.measureViewportBox(), E.getComputedStyle(e.current))),
      ...
      (td = class {
        ...
        bindToMotionValue(e, t) {
          ...
          let r = t.on(`change`, (t) => {
            ...
            i;
          (E !== void 0 && E.MotionCheckAppearSync && (i = E.MotionCheckAppearSync(this, e, t)),
            this.valueSubscriptions.set(e, () => {
              (r(), i && i());
            }));
        }
      ...
      (dd = class extends nd {
        ...
        readValueFromInstance(e, t) {
          if (gl.has(t)) return this.projection?.isProjecting ? Dt(t) : ml(e, t);
          {
            let n = Ar(e),
      ...
      (Wd = (e) => d !== void 0 && d.userAgent && d.userAgent.toLowerCase().includes(e)),
      ...
      (Yd = bi({
        ...
        defaultParent: () => {
          if (!Jd.current) {
            let e = new Kd({});
            (e.mount(E), e.setOptions({ layoutScroll: !0 }), (Jd.current = e));
          }
          return Jd.current;
        },
        resetTransform: (e, t) => {
        ...
        checkIsScrollRoot: (e) => E.getComputedStyle(e).position === `fixed`,
      })),
      ...
      (Zd = ({
        ...
        return (
          ...
          m(js.Provider, { value: y, children: e })
        );
      }),
      (Qd = (e) => e.key || ``),
      ($d = ({
        ...
        if (g !== w) {
          ...
          for (let t = 0; t < E.length; t++) {
            let n = E[t],
              r = Qd(n);
            _.includes(r) || (e.splice(t, 0, n), D.push(n));
          }
          return (s === `wait` && D.length && (e = D), ee(Zi(e)), T(g), null);
        }
        let { forceRender: te } = n(Os);
        return m(S, {
          children: E.map((e) => {
            let n = Qd(e),
              i = c && !p ? !1 : g === E || _.includes(n);
            return m(
              Zd,
              {
                isPresent: i,
      ...
      (rf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        c.current === null &&
          (nf(r) && u && (t = t ? u + `-` + t : u),
          (c.current = { id: t, group: (tf(r) && i.group) || Wi() }));
        let d = v(() => ({ ...c.current, forceRender: o }), [s]);
        return m(Os.Provider, { value: d, children: e });
      }),
      (af = a({ strict: !1 })),
      (of = {
        animation: [
      ...
      (lf = (e) => !ra(e)));
    try {
      ia(le(`@emotion/is-prop-valid`).default);
    } catch {}
    ((uf = a({})),
      (df = (e) => (t, r) => {
        let i = n(uf),
      ...
      (wf = (e, t) => Math.abs(e - t)),
      (Tf = (e, t) => ((t.isSVG ?? _a(e)) ? new vd(t) : new dd(t, { allowProjection: e !== u }))),
      ...
      (Of = class {
        constructor(
          ...
          ((this.dragSnapToOrigin = i),
            ...
            (this.contextWindow = r || E));
          let s = Ma(ka(e), this.transformPagePoint),
            { point: c } = s,
            { timestamp: l } = V;
          this.history = [{ ...c, timestamp: l }];
          let { onSessionStart: u } = t;
          u && u(e, Pa(s, this.history));
          let d = { passive: !0, capture: !0 };
          ((this.removeListeners = Fs(
            Aa(this.contextWindow, `pointermove`, this.handlePointerMove, d),
            Aa(this.contextWindow, `pointerup`, this.handlePointerUp, d),
            Aa(this.contextWindow, `pointercancel`, this.handlePointerUp, d)
          )),
        ...
        startScrollTracking(e) {
          ...
          (this.scrollPositions.set(E, { x: E.scrollX, y: E.scrollY }),
            E.addEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
            E.addEventListener(`scroll`, this.onWindowScroll),
            (this.removeScrollListeners = () => {
              (E.removeEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
        ...
        handleScroll(e) {
          ...
          if (!t) return;
          let n = e === E,
            r = n ? { x: E.scrollX, y: E.scrollY } : { x: e.scrollLeft, y: e.scrollTop },
      ...
      (jf = class {
        ...
        addListeners() {
          ...
          let o = hi(E, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (cp = new WeakMap()),
      (lp = new WeakMap()),
      (up = (e) => (e === document.scrollingElement ? E : e)),
      (dp = [
        [rp.Enter, `entry`],
        [rp.Exit, `exit`],
        [rp.Any, `cover`],
...
//# sourceMappingURL=motion.D-FJ70EG.mjs.map
