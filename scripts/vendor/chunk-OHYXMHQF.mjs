var x = "__framer_force_showing_editorbar_since",
  w = "__framer_editor_button_position",
  s = "2147483647";
var O = 300;
var i = 12,
  d =
  ...
  l = "__framer-editorbar-container",
  a = "__framer-editorbar-label",
  f = "__framer-editorbar-button",
  u = "__framer-editorbar-loading-spinner",
  E = "__framer-editorbar-button-tooltip-visible",
  m = `
#${l} {
    align-items: center;
    display: flex;
