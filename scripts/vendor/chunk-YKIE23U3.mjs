...
function Z(e, n, a) {
  ...
  let t = a.maxBandwidthInGB ?? 1 / 0,
    { previousMonth: m, twoMonthsAgo: h, currentMonth: s } = n.bandwidthInGB,
    p = m > t && h > t,
    g = m > t && s > t;
  if ((p || g) && !(X === t)) return "bandwidth";
}
var pe = {
...
function Xe({ isEnterprise: e, count: n, maxLimit: a, selfServeMax: t }) {
  return e ? 3 : n <= a ? 1 : n <= t ? 0 : 2;
}
var J = ((o) => (
  (o.fileUploadLimitInMB = "fileUploadLimitInMB"),
  (o.pages = "pages"),
  (o.cmsCollections = "cmsCollections"),
  (o.cmsItems = "cmsItems"),
  (o.localeAddon = "localeAddon"),
  (o.abTests = "abTests"),
  (o.trackingEventsLimit = "trackingEventsLimit"),
  (o.translatableWords = "translatableWords"),
  (o.bandwidthInGB = "bandwidthInGB"),
  (o.analyticsRangeInDays = "analyticsRangeInDays"),
  (o.staticFiles = "staticFiles"),
  (o.aiCredits = "aiCredits"),
  (o.canUseFunnels = "canUseFunnels"),
  (o.canUseTriggers = "canUseTriggers"),
  (o.canInviteEditors = "canInviteEditors"),
  (o.canInviteProjectEditors = "canInviteProjectEditors"),
  (o.canPublishToCustomDomain = "canPublishToCustomDomain"),
  (o.canUseBatchAITranslation = "canUseBatchAITranslation"),
  (o.canUseBranching = "canUseBranching"),
  (o.canUseCustomCanonicalUrl = "canUseCustomCanonicalUrl"),
  (o.canUseCustomHeaders = "canUseCustomHeaders"),
  (o.canUseFirewall = "canUseFirewall"),
  (o.canUseCustomLocaleRegions = "canUseCustomLocaleRegions"),
  (o.canUseEditorPermissions = "canUseEditorPermissions"),
  (o.canUseInternalRewrites = "canUseInternalRewrites"),
  (o.canUsePasswordProtection = "canUsePasswordProtection"),
  (o.canUseRedirects = "canUseRedirects"),
  (o.canUseStagingEnvironment = "canUseStagingEnvironment"),
  (o.canUseUTMTracking = "canUseUTMTracking"),
  (o.canUseWellKnown = "canUseWellKnown"),
  (o.customDomainRecoverUpsell = "customDomainRecoverUpsell"),
  (o.domainToBuyUpsell = "domainToBuyUpsell"),
  o
))(J || {});
function qe(e) {
  return e in J;
...
function Je(e, n, a, t, m) {
  ...
  switch (e) {
    ...
    case "fileUploadLimitInMB":
      return d(s, t, "fileUploadLimitInMB");
    case "staticFiles":
      return d(s, t, "staticFiles");
    case "cmsCollections":
      return d(s, t, "cmsCollections");
    case "cmsItems":
      return d(s, t, "cmsItems");
    case "canUseEditorPermissions":
      return u(s, "canUseEditorPermissions", "on");
    case "canPublishToCustomDomain":
    case "customDomainRecoverUpsell":
    case "domainToBuyUpsell":
      return u(s, "canPublishToCustomDomain", "on");
    case "canInviteEditors":
    case "canInviteProjectEditors":
      return d(s, t, "maxEditors");
    case "translatableWords":
    case "localeAddon":
      return d(s, t, "maxLocales");
    case "canUseBatchAITranslation":
      return u(s, "canUseBatchAITranslation", "on");
    case "canUseBranching":
      return u(s, "canUseBranching", "on");
    case "canUseUTMTracking":
      return u(s, "canUseUTMTracking", "on");
    case "canUseFunnels":
      return u(s, "canUseFunnels", "upsell");
    case "canUseTriggers":
      return u(s, "canUseTriggers", "upsell");
    case "abTests":
      return d(s, t, "maxAbTests");
    case "trackingEventsLimit":
      return d(s, t, "maxTrackingEventsLimit");
    case "canUseRedirects":
      return u(s, "canUseRedirects", "on");
    case "canUseInternalRewrites":
      return u(s, "canUseInternalRewrites", "on");
    case "canUseCustomHeaders":
      return u(s, "canUseCustomHeaders", "on");
    case "canUseCustomCanonicalUrl":
      return u(s, "canUseCustomCanonicalUrl", "upsell");
    case "canUseFirewall":
      return u(s, "canUseFirewall", "on");
    case "canUseCustomLocaleRegions":
      return u(s, "canUseCustomLocaleRegions", "on");
    case "canUsePasswordProtection":
      return u(s, "canUsePasswordProtection", "on");
    case "canUseStagingEnvironment":
      return u(s, "canUseStagingEnvironment", "on");
    case "canUseWellKnown":
      return u(s, "canUseWellKnown", "on");
    case "analyticsRangeInDays":
      return d(s, t, "analyticsRangeInDays");
    case "bandwidthInGB":
      return d(s, t, "bandwidthInGB");
    case "aiCredits":
      return d(s, t, "aiCredits");
  }
}
...
function ne(e = r) {
  ...
  let t = B(e.environment, r.environment);
  return t === "production" ? n : `${n}:${t}`;
}
function Ce(e = r) {
...
var ae = [
  ...
  V = new Map(O.map((e) => [e.languageModel, e]));
function S(e) {
  return V.has(e);
}
function mn(e, n) {
  ...
  let { selection: t } = a;
  return "override" in t
    ? ne(n ?? r)
    : "alias" in t
      ? t.alias
      : t.provider === "fireworks"
        ? t.modelId
        : `${t.modelId}:${t.deployment}`;
}
function pn(e) {
  let n = V.get(e);
...
function fn(e, n) {
  let a = O.filter((t) => "override" in t.selection || t.selection.provider === e).map((t) => [
    t.languageModel,
    n(t),
  ]);
...
var te = new Set(["low", "high", "max"]),
  ...
  xe = L((e) => (e.base === "triton" ? "low" : e.base === "hex" ? "none" : "enabled")),
  Fe = new Set([
    "none",
    "enabled",
    "minimal",
...
function Ae(e, n) {
  ...
  switch (e) {
    ...
    case "high": {
      ...
      return K(n) ? { enabled: !0 } : { effort: e, enabled: !0 };
    }
    case "max":
      return { effort: e, enabled: !0 };
    case "xhigh":
...
function In(e, n) {
  if (!(F(e) || !K(n) || !be(e))) return { verbosity: e };
}
var se = "effort";
function En(e, n) {
  let a = Ae(e, n);
...
function l(e, n, a) {
  return { multiplier: n, description: { name: e, body: a(`${n}\xD7`, Be) } };
}
var k = {
...
function i(e) {
  return { allowedFileTypes: ["image/*"], maxAttachments: ie, totalSizeLimit: re, ...e };
}
var U = {
  "openai/gpt-5.1": i(),
  "openai/gpt-5.2": i(),
  ...
  "anthropic/claude-sonnet-4.5": i(c),
  "anthropic/claude-opus-4.5": i(c),
  "anthropic/claude-sonnet-4.6": i(c),
  "anthropic/claude-sonnet-5": i(c),
  "anthropic/claude-opus-4.6": i(c),
  "anthropic/claude-opus-4.7": i(c),
  "anthropic/claude-opus-4.8": i(c),
  "anthropic/claude-opus-5": i(c),
  "anthropic/claude-fable-5": i(c),
  "anthropic/claude-fable-5.1": i(c),
  "anthropic/claude-haiku-4.5": i(c),
};
function _e(e = M) {
...
function Un(e = M) {
  return _e(e) !== void 0 || Ke(e) !== void 0 || Re(e) !== void 0;
}
function ke(e) {
  return e * 1024 * 1024;
}
function Dn(e) {
  if (S(e)) return "framer";
  switch (e) {
    case "anthropic/claude-haiku-4.5":
    case "anthropic/claude-sonnet-4.5":
    case "anthropic/claude-sonnet-4.6":
...
async function Xn({
  ...
  let y = 0,
    ...
    ce = 100 / j;
  try {
    let C = await q(e, { [n]: a }, (v) => {
      if (b) return;
      let T = Math.round(v * j);
      if (T === y) return;
      y = T;
      let x = Math.round(y * ce * 0.95);
      (!N && x >= 90) ||
        ((N = !0),
        m({
          type: "add",
