...
var A = P((r) => {
  ...
  var t = typeof Symbol == "function" && Symbol.for,
    ...
    T = t ? Symbol.for("react.portal") : 60106,
    ...
    g = t ? Symbol.for("react.async_mode") : 60111,
    ...
    L = t ? Symbol.for("react.block") : 60121,
...
var X = P((re, C) => {
  ...
  var w = N(),
    ...
    B = { name: !0, length: !0, prototype: !0, caller: !0, callee: !0, arguments: !0, arity: !0 },
    G = { $$typeof: !0, render: !0, defaultProps: !0, displayName: !0, propTypes: !0 },
    D = { $$typeof: !0, compare: !0, defaultProps: !0, displayName: !0, propTypes: !0, type: !0 },
    x = {};
  x[w.ForwardRef] = G;
  x[w.Memo] = D;
  function F(e) {
    return w.isMemo(e) ? D : x[e.$$typeof] || Y;
  }
  ...
  function I(e, n, b) {
    if (typeof n != "string") {
      ...
      var c = J(n);
      R && (c = c.concat(R(n)));
      for (var j = F(e), M = F(n), v = 0; v < c.length; ++v) {
        var f = c[v];
        if (!B[f] && !(b && b[f]) && !(M && M[f]) && !(j && j[f])) {
          var q = Q(n, f);
          try {
            H(e, f, q);
          } catch {}
