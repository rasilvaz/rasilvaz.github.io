import { g as le, i as Ie } from "./chunk-4DKPSRYC.mjs";
import { za as ce } from "./chunk-TVSBUEV2.mjs";
import {
  Ka as Ee,
  Ma as xe,
  Na as Le,
...
import { r as Te, s as ae } from "./chunk-XGYHMCIU.mjs";
import { b as be, j as X, m as Y } from "./chunk-ZXYWZMUN.mjs";
import { b as G } from "./chunk-HHSQRZXJ.mjs";
import { q as A } from "./chunk-4BL4NTEI.mjs";
import { k as de, l as D, p as Ce } from "./chunk-NLHKIDQT.mjs";
import { Md as ve, k as Se } from "./chunk-3J64XJNF.mjs";
import { a as ge, h as ye } from "./chunk-5JQQYZG5.mjs";
import { Ph as $ } from "./chunk-CXXFSPZR.mjs";
import { a as J } from "./chunk-GBWZWM2Q.mjs";
import { o as pe } from "./chunk-EERSFQYH.mjs";
import { a as F } from "./chunk-5WDLMAA7.mjs";
import { a as O } from "./chunk-HZLWYBUG.mjs";
import { b as fe } from "./chunk-LA34HORX.mjs";
import { a as Xe } from "./chunk-W774OHJB.mjs";
import { b as c, c as ue } from "./chunk-4JY5UMT2.mjs";
import { l as N } from "./chunk-NKL3YJZC.mjs";
import { c as W, h as S } from "./chunk-KPMZENE5.mjs";
...
var he = S("remote:sync"),
  ...
  Q = class {
    ...
    add(e, t, r, n) {
      ...
      return (
        he.debug("create CRDT rows message:", e.length, "inflight:", this.unconfirmed.size, o.seq),
    ...
    take(e, t) {
      ...
      return (
        c(r, `No unconfirmed update for message seq ${e}. Pass the seq that add returned.`),
        r.attempts++,
        (r.lastAttemptAt = t),
        me(r)
      );
    ...
    takePendingRetries(e) {
      ...
      for (let r of this.unconfirmed.values()) {
        let n = r.attempts > 0 ? Ye[r.attempts - 1] : 0;
        if (n === void 0 || e - r.lastAttemptAt < n) continue;
        (he.info("retrying unconfirmed update", { seq: r.seq, attempts: r.attempts }),
          r.attempts++,
          (r.lastAttemptAt = e));
        let o = me(r);
        ((o.reasons = [r.reasons, De].filter(Boolean).join(" ")), t.push(o));
      }
      return t;
    }
    takeAllForReconnect(e) {
      ...
      for (let r of this.unconfirmed.values()) {
        ...
        let n = me(r);
        ((n.reasons = [r.reasons, De].filter(Boolean).join(" ")), t.push(n));
      }
      return t;
    }
    confirm(e) {
      ...
      return (
        ...
        Ke(t) &&
          (he.info("confirm arrived for a retried update", { seq: e, attempts: t.attempts }),
...
function me({ seq: a, rows: e, reasons: t, ts: r, appEnvironment: n }) {
...
var x = S("remote:sync"),
  ...
  Z = class {
    ...
    checkRemoteVersion(e, t, r = this.treeVersion) {
      return (
        c(Number.isFinite(e), `${t === "confirm" ? "Confirm" : "Update"} must have tree version`),
    ...
    handleInit(e, t) {
      return (
        (this.init += 1),
        this.init === 1 && (X("wsTreeInitMessages"), Y(t)),
    ...
    createUnconfirmedMessages(e = Date.now()) {
      return (c(this.isReady), this.outbox.takeAllForReconnect(e));
    }
...
var et = { children: !0, contentHash: !0, parentid: !0, $keep: !0 };
function tt(a, e) {
  if (a !== "cached") return e;
}
function Fe(a) {
  if (a === void 0) return;
  let e = JSON.stringify(a, tt);
  if (e !== void 0) return JSON.parse(e);
}
function rt(a, e) {
  return F(a, e) ? !1 : a === void 0 || e === void 0 ? !0 : !F(Fe(a), Fe(e));
}
function Ae(a, e, t) {
  ...
  function s(m, y) {
    ...
    for (let f of r.getChildrenIds(m)) s(f, y);
  }
  function d(m, y) {
    ((y += "." + m), o.has(m) || ((i = !0), t.push("+node: " + y)));
...
var V = S("remote:connection"),
  ...
  Ve = class {
    constructor(e, t, r, n, o, i, s) {
      ...
      this.callbacks = o;
      this.localCache = i;
      (c(e instanceof ke, "tree updater must be a CrdtTreeCommitter"),
        (this.treeSync = new Z(e)),
        (this.treeSync.appEnvironment = s),
        (this.treeSync.waitingForTree = !0),
        !N.benchmarkSkipTreeVerify &&
    ...
    processViewOnly() {
      this.store.seq <= 0 ||
        ...
        V.warn("cannot create local updates when the user is a viewer"));
    }
    handleRows(e, t) {
    ...
    applyCollectedRows(e, t) {
      ...
      let r = this.treeSync.committer,
        n = xe(r.branches, e, r.effectiveViewBranchId);
      Le(r.effectiveViewStore, r.tree, n);
    ...
    processRemoteUpdates() {
      if (
        ...
        V.debug("processRemoteUpdates: exiting early - waitingForTree=true");
        return;
      }
      if (this.loader?.activelyLoadingScope) {
        V.debug("processRemoteUpdates: exiting early - activelyLoadingScope=true");
        return;
      }
      let e;
      try {
        ...
        for (; this.remoteUpdates.length > 0; ) {
          ...
          if (!n) break;
          if (((e = n), !Ne(n))) {
            (this.applyCollectedRows(t, r), (t = new B()), (r = this.treeSync.treeVersion));
          ...
          if (
            (c(typeof n.next == "number", "Update must have tree version"),
        ...
        if (
          ...
          if (!n.some((i) => _(i) && i.isValid())) {
            V.info("cannot show any page, forcing load of next page");
            let i = n.find((d) => _(d));
        ...
        let r = W(t);
        throw (
          V.error("Error processing remote updates:", r, {
            updateVersions: this.remoteUpdates.map((n) => n.next),
          }),
          V.debug("Last update:", e),
          (this.remoteUpdates.length = 0),
    ...
    maybeSend(e) {
      ...
      if (this.treeSync.outbox.size >= it) return "postpone";
...
`)
    ...
    createRemoteStore(e) {
      ...
      for (let d of r.getBranchPath(o)) {
        let l = r.getStore(d);
        i = n.getStore(d);
        let h = l.compare(i.manifest);
        for (let m of h.extra) s.extra.push(m);
        for (let m of h.missing) s.missing.push(m);
        this.appendLocalRowsMissingFromServer(l, i, h.extra);
      }
    ...
    appendLocalRowsMissingFromServer(e, t, r) {
      ...
      for (let i of r) {
        ...
        c(s, () => `unable to find local rows for timestamp ${i.client} ${i.seq}`);
    ...
    resetTreesForRecovery(e) {
      if (!this.loader) {
        ...
        return be({ version: Se, root: r }, this.componentLoader, t);
      }
...
function mt(a) {
  return Math.min(at * 2 ** a, He);
}
function Be(a, e) {
  let t = 1 - _e + e() * _e * 2;
  return Math.min(Math.round(a * t), He);
}
function ut(a, e, t = Math.random) {
  return a === "ReconnectToNewServer"
    ? { delay: Be(dt, t), nextReconnectAttempt: e }
    : { delay: Be(mt(e), t), nextReconnectAttempt: e + 1 };
}
function fr({ url: a, documentConnection: e, tunnel: t, getSubprotocols: r }) {
  ...
  let f = (0, v.useCallback)(() => {
    ...
    p = (0, v.useCallback)(async () => {
      ...
      function u(w) {
        l.current === void 0 &&
          (l.current = window.setTimeout(() => {
            ((l.current = void 0),
              navigator.onLine && ((document.hidden && !N.isApiPlugin) || p()));
          }, w));
      }
      let g = new URL(s.current);
      if (
        (g.searchParams.set("v", lt.toString()),
      ...
      let I = new WebSocket(g.href, b),
        E = new ee(),
        se = { ws: I, stats: E, clientClosed: !1 };
      e.setSocketStats(E);
      let q = 0,
        j = 0;
      (I.addEventListener("open", () => {
        ...
        I.addEventListener("close", (w) => {
          let R = pt(w);
          if (
            (L.debug("close:", R, "clientClosed:", se.clientClosed, w),
            q !== 0 && (clearInterval(q), (q = 0)),
            j !== 0 && (clearTimeout(j), (j = 0)),
            n.current === se)
          ) {
            ht(R) || (d.current = !1);
            for (let M of i.current.onDisconnect)
              try {
                M(R);
              } catch (z) {
                L.warn("Error in onDisconnect handler:", z);
              }
            if (((n.current = null), d.current)) {
              let { delay: M, nextReconnectAttempt: z } = ut(R, h.current);
              ((h.current = z), u(M));
            }
          }
        }),
        I.addEventListener("message", (w) => {
          try {
            ...
            if (M.type === "ack") {
              E.acked();
              return;
            } else M.type === "redirect" && (s.current = M.value.url);
            for (let z of i.current.onMessage)
              try {
                z(M);
              } catch (Ge) {
                L.warn("Error in onMessage handler:", Ge);
              }
          } catch (R) {
  ...
  let C = (0, v.useCallback)(
    ({ online: u, visible: g }) => {
      u && (g || N.isApiPlugin) ? p() : N.isApiPlugin || y();
    },
    [p]
  );
  return (
    ...
    (0, v.useMemo)(
      () => ({
        ...
        onConnect(u) {
          return (
            i.current.onConnect.add(u),
            () => {
              i.current.onConnect.delete(u);
            }
          );
        },
        onDisconnect(u) {
          return (
            i.current.onDisconnect.add(u),
            () => {
              i.current.onDisconnect.delete(u);
            }
          );
        },
        onMessage(u) {
          return (
            i.current.onMessage.add(u),
            () => {
              i.current.onMessage.delete(u);
            }
          );
        },
        send(u) {
...
var yt = S("app");
function Sr() {
  (yt.reportError("Socket message too big"),
    G({
      type: "add",
      variant: "error",
...
function te(a) {
  return je(a) && "session" in a;
}
function re(a) {
  return je(a) && "changes" in a && Array.isArray(a.changes);
}
var k = S("remote:sync"),
  ze = 2 ** 52,
  ne = class {
    ...
    verify(e, t) {
      ...
      if (!r) return (k.info("verify: unable to find tree with version", e), !0);
      let n = r.computeTreeHash();
      if (n !== t) {
        if ((k.warn("verify: failed", n, "!==", t), t === 0)) return !0;
        k.reportError("Tree verification failed", {
          localHash: n,
          serverHash: t,
          treeVersion: e,
          treeSize: r.size(),
        });
      } else k.debug("verify: passed; hash:", t);
      return n === t;
    }
    setTree(e, t, r) {
      (k.info("setTree", t),
    ...
    handleInit(e, t) {
      return (
        (this.init += 1),
        this.init === 1 && (X("wsTreeInitMessages"), Y(t)),
        k.info("init", this.init, {
          treeVersion: e,
          initialUpdates: t,
          localTreeVersion: this.treeVersion,
        }),
        k.debug("init updates:", {
    ...
    loadedAllScopes() {
      ...
      (k.info(
        ...
        c(e.isPartialLoading, "Must be in loading mode"),
    ...
    loadOneScope(e, t) {
      let r = this.timeline;
      (k.debug("loadOneScope:", e.id),
        c(r.isPartialLoading, "Must be loading"),
        c(!e.cache.isShallowLoad, "Scope must not be shallow"));
      let n = this.getRemoteEntry();
      c(n, "remote tree is missing");
      ...
      if (this.rollingDiff) {
        ...
        for (let y of r.entries) {
          if (l > m) break;
          (l++,
            !y.wasScopeInsert && ((h && !de(y.changes, i)) || ((h = !1), D(n.tree, y.changes))));
        }
      }
      s === -1
        ? c(!n.tree.get(e.id), "Scope must have been deleted by remote diffs")
        : n.tree.loadReplicasAndCodeComponents(e);
      let d = n.tree.commit(this.componentLoader, (l, h) => {
        let m = l?.id ?? h?.id;
        m && r.trackChange(m);
      });
      return (
    ...
    setRemoteTreeVersion(e) {
      ...
      let t = this.getRemoteEntry();
      (c(t, "remote tree is missing"), (t.version = e));
    }
  };
var U = S("remote:sync"),
  oe = class extends ne {
    ...
    handleRemoteUpdate(e) {
      if (this.hasError || this.waitingForTree) return;
      c(typeof e.next == "number", "must be a valid tree update");
      let t = e.next;
      if (
    ...
    confirmLocalChangesByRemote(e, t = 0) {
      let r = this.timeline;
      if (
        (c(e >= 1, "cannot confirm less than one change"),
        c(
          this.localChangesSentToRemote >= e,
          "cannot confirm local changes that have not been sent"
        ),
        c(r.remoteTreeIndex < r.localTreeIndex, "must have unconfirmed local changes"),
        this.rollingDiff)
      )
        for (let n = 1; n <= e; n++)
    ...
    insertRemoteChanges(e, t = 0) {
      ...
      (U.debug("insertRemoteChanges:", e.length),
        c(r.tree === r.getLastEntry().tree, "tree out of sync"),
        c(r.remoteTreeIndex <= r.localTreeIndex, "remote tree too far ahead"),
    ...
    addRemoteTreeWithChanges(e, t) {
      ...
      return (
        c(e.lineage === r.tree.lineage, "Trees must belong to the same line."),
        c(!e.hasUncommittedChanges(), "Tree cannot have uncommitted changes."),
    ...
    rebaseRemoteTreeWithChanges(e, t, r) {
      ...
      (U.debug("rebaseRemoteTreeWithChanges:", r, "changes:", t.length),
        c(e.lineage === n.getLastEntry().tree.lineage, "Trees must belong to the same line."),
        c(!e.hasUncommittedChanges(), "Tree cannot have uncommitted changes."),
        c(n.entries.length >= r, () => `rebase ${r} > commits ${n.entries.length}`));
      let o = n.entries.splice(n.entries.length - r, r);
      c(o.length === r, () => `must have ${r} entries to process`);
      let i = n.addEntry(e, t, [], !0),
        s = e;
      for (let d = 0; d < r; d++) {
        let l = o[d];
        (D(e, l.changes), (e = e.commitDiffs(this.componentLoader)));
        for (let h of l.changes) n.trackChange(h.id, h);
        for (let h of s.getNodesChangedByCommit()) n.trackChange(h.id);
    ...
    loadCompleteTree(e, t = 0) {
      ...
      (U.debug(
        ...
        c(r.trimmed === 0, "cannot load complete tree while having local changes"),
        c(!e.hasUncommittedChanges(), "tree should be clean"),
        r.entries.forEach((s, d) => {
          d > r.remoteTreeIndex || D(e, s.changes);
        }),
      ...
      if (o.sizeAtStart() * 2 > e.size()) {
        ...
        for (let d of e.root.walk()) {
          let l = o.getNodeAtStart(d.id) || void 0,
            h = Ce(l, d);
          (h && (s[h.id] = h), r.trackChange(d.id, h));
        }
        ((n = Object.values(s)), U.debug("load complete tree, diff:", n.length));
      } else (r.invalidateAllCursors(), U.debug("load complete tree, resending:", r.tree.size()));
      (r.incrementRemoteTreeIndex(1), (r.latestReversibleNodeChanges = null));
      let i = r.entries.length - r.remoteTreeIndex;
      return (
        c(i >= 0, "computed rebase is off"),
    ...
    hasChangesForRemote() {
      ...
      return (c(e <= t, "inconsistency in getting local changes to send"), e < t);
    }
    hasOnlyEmptyChangesForRemote() {
      let e = this.timeline.remoteTreeIndex + this.localChangesSentToRemote,
        t = this.timeline.localTreeIndex;
    ...
    commitAndCreateUpdate(e = 0) {
      (c(N.isTest), this.timeline.commitLocalTree());
...
var St = { cache: !0, update: !0, mutable: !0, children: !0 };
function vt(a, e) {
  if (a !== "cached") return e;
}
function We(a) {
  return JSON.parse(JSON.stringify(a, vt));
}
function qe(a, e, t) {
  let r = new Set(),
    n = !1;
  function o(s, d) {
    (r.add(s.id), (d += "." + s.id));
    let l = e.get(s.id);
    if (!l) ((n = !0), t.push("-node: " + d + ($(s) ? " (replica child)" : "")));
    else {
      let h = [],
        m = s.children?.map((f) => f.id).join(","),
        y = l.children?.map((f) => f.id).join(",");
      ...
      for (let [f, p] of s.entries()) {
        ...
        F(p, C)
          ...
          : (p === void 0 || C === void 0 || !F(We(p), We(C))) &&
            f !== "contentHash" &&
            h.push(" ." + f + ": " + JSON.stringify(p) + " != " + JSON.stringify(C));
      }
      h.length > 0 &&
        ((n = !0), t.push("!node: " + d + ($(s) ? " (replica child)" : "")), t.push(...h));
    }
    for (let h of s.children ?? []) o(h, d);
  }
  function i(s, d) {
    ((d += "." + s.id),
      r.has(s.id) || ((n = !0), t.push("+node: " + d + ($(s) ? " (replica child)" : ""))));
    for (let l of s.children ?? []) i(l, d);
  }
  return (o(a.root, ""), i(e.root, ""), n);
}
var H = S("remote:connection"),
  P = S("remote:verify"),
  Tt = 5,
  $e = class {
    constructor(e, t, r, n, o) {
      ...
      this.projectId = r;
      this.callbacks = n;
      (c(e instanceof Re, "timeline must be a TreeTimeline"),
    ...
    processViewOnly() {
      ...
      (H.warn("cannot create local updates when the user is a viewer, ignoring:", e),
    ...
    maybeSend(e) {
      ...
      if (t >= Tt) return "postpone";
      let r = this.treeSync.createUpdateToSend();
      return r
        ? (H.debug("sending update:", t, r.changes.length, r.reasons),
          e.sendMessage({ type: "treeUpdate", value: K(r) }),
          "didSend")
        : "nothingToSend";
    }
    handleRows() {
    ...
    async verifyLocalTreeWithServer(e, t, r, n) {
      try {
        let o = e.replace(/\d+\.json/u, r + ".json"),
          i = await fetch(o, await A.withAuthorizationHeader({}));
...
`)
            ...
            (o = Error("Local document different from server document.")),
            P.reportError(o, { differences: i, changes: n?.slice(-25).map((d) => d.changes) }))
          : i.length > 0
            ? P.debug(
                `trees have warnings:
` +
...
`)
    ...
    processRemoteUpdates() {
      ...
      try {
        if (
          (c(!this.timeline.tree.hasUncommittedChanges(), "tree must not have uncommitted changes"),
          this.shouldCrashFromDebug)
        )
          throw ((this.shouldCrashFromDebug = !1), Error("RemoteDocument CrashTest"));
        for (; this.remoteUpdates.length > 0; ) {
        ...
        if (this.loader) {
          ...
          if (!t.some((n) => _(n) && n.isValid())) {
            H.info("cannot show any page, forcing load of next page");
            let n = t.find((i) => _(i));
        ...
        throw (
          (this.remoteUpdates.length = 0),
          H.error("Error processing remote updates:", r),
          H.debug("Last update:", e),
          this.treeSync.error(r.message),
          this.callbacks.errorRecoverable(),
          r
        );
    ...
    async verifyTreeWithServer() {
      ...
      this.ignoreTreeVerifyVersion = o;
      let d = await r.text(),
        l = await this.loadServerTree(d, t.toString(), o),
        h = this.compareTreeWithServerJson(s, l, o);
      if (h) throw h;
      return i;
    }
    async loadServerTree(e, t, r) {
      c(!e || fe(e), "treeData must be a string");
      let n,
      ...
      return (
        o.on("loadedFirstData", (i) => {
          (o.on("loadedScope", (s) => {
            let d = i.root.children.findIndex((l) => l.id === s.id);
    ...
    flushUpdates(e) {
      ...
      return (t && e.sendMessage({ type: "treeUpdate", value: K(t) }), !0);
    }
    resendUnconfirmedUpdates(e) {
      c(this.isReady);
      let t = this.localUpdatesAtInit.filter((r) => !r.confirmed);
      if (t.length !== 0) {
        H.debug("resending local updates:", t.length);
        for (let r of t) e.sendMessage({ type: "treeUpdate", value: K(r) });
      }
    }
...
//# sourceMappingURL=https://app.framerstatic.com/chunk-FWCJYKTM.mjs.map
